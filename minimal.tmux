...
status_left="#S"
status_right="#[bg=default,fg=default,bold]#{?client_prefix,,${indicator}}#[bg=${bg},fg=black,bold]#{?client_prefix,${indicator},}#[bg=default,fg=default,bold]"
expanded_icon="󰊓"
show_expanded_icon_for_all_tabs=$(get_tmux_option "@minimal-tmux-show-expanded-icon-for-all-tabs" false)

status_right_extra="$status_left$(get_tmux_option "@minimal-tmux-status-right-extra" '')"
status_left_extra="$status_right$(get_tmux_option "@minimal-tmux-status-left-extra" '')"
